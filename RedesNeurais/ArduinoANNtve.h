...
class ArduinoANN
{
  ...
  //ArduinoANN();
  //ArduinoANN(byte _Input[], byte _Target[], int _PatternCount, int _InputNodes, int _OutputNodes);
  ArduinoANN(int _PatternCount, int _InputNodes, int _OutputNodes, int _RowNol, int _ColNol, byte* aArray);
  void Train();
