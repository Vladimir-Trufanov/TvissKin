...
ArduinoANN::ArduinoANN(int _PatternCount, int _InputNodes, int _OutputNodes, int _RowNol, int _ColNol, byte* aArray)
{
   RowNol=_RowNol;
   ColNol=_ColNol;
   byte myArray[RowNol][ColNol];
   memcpy(aArray, myArray, RowNol);
...
void ArduinoANN::Train()
{
   ...
   Serial.print("RowNol=");  Serial.println(RowNol);
   Serial.print("ColNol=");  Serial.println(ColNol);
