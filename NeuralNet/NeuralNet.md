...
#### Открытие файлов и получение их содержимого - [ViewReadlines](ViewReadlines.ipynb):
```
...
data_list[0]
```
#### Просмотр строк файла MNIST в графическом представлении - [ViewMNIST](ViewMNIST.ipynb):
```
...
```
![Показана четверка](chetverka.jpg)

#### Перевод значений цветов в оптимальный диапазон для функции активации - [ScaledMNIST](ScaledMNIST.ipynb):

Для этого нужно перевести значения цветовых кодов из диапазона значений 0-255 в намного меньший, охватывающий значения от 0,01 до 1,0 (ноль исключаем, чтобы избежать проблем с расчетами - блокировкой обновление весов). 

Делаем это путем масштабирования и сдвига - умножением значений на коэффициент 0,99 и добавлением (инкрементированием) на 0,01.
...
[На Ютубе: https://www.youtube.com/playlist?list=PLfdVzZl6HHg9y9l6U5xUjqKS13rWoQPF4](https://www.youtube.com/playlist?list=PLfdVzZl6HHg9y9l6U5xUjqKS13rWoQPF4)
